...
final class StockComparisonFormattingTests: XCTestCase {
  ...
  func testPercentFormatting() async {
    await Task.yield()
    let value = 0.1563
  ...
  func testMultipleFormatting() async {
    await Task.yield()
    let value = 24.46
  ...
  func testCompactCurrencyFormatting() async {
    await Task.yield()
  ...
  func testCompactNumberFormatting() async {
    await Task.yield()
    let billions = 1_234_567_890.0
  ...
  func testSignedFormatting() async {
    await Task.yield()
    let pos = 123.45
    let neg = -123.45
  ...
  func testMetricFormattingMapping() async {
    await Task.yield()
