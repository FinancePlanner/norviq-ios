...
final class RetailSentimentDisplayTests: XCTestCase {
  ...
  func testNilScoreIsAbsenceNotNeutral() async {
    await Task.yield()
  ...
  func testMissingSentimentIsAbsence() async {
    await Task.yield()
    XCTAssertFalse(RetailSentimentDisplay(nil).hasReading)
  }

  func testScoreRendersOnHundredScale() async {
    await Task.yield()
  ...
  func testNegativeScoreKeepsSign() async {
    await Task.yield()
  ...
  func testPostLabelPluralizes() async {
    await Task.yield()
  ...
  func testColorTreatsSynonymsAlike() async {
    await Task.yield()
    XCTAssertEqual(
  ...
  func testSourceCountsTotal() async {
    await Task.yield()
  ...
  func testSymbolChunkingRespectsServerCap() async {
    await Task.yield()
  ...
  func testNormalizeUppercasesTrimsAndDeduplicates() async {
    await Task.yield()
